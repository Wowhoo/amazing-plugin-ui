    ...
    var Plugin = $[pluginName] = function(element, options) {
        ...
        $.extend(self, {
            ...
            fontFamily: {
                ...
                set: function(value) {
                    if(!value) {
                        this.$font_family.data('dropdown').set("inherit");
                    } else {
            ...
            fontWeight: {
                ...
                set: function(value) {
                    if(!value) {
                        this.$font_weight.data('dropdown').set("inherit");
                    } else {
            ...
            fontSize: {
                ...
                set: function(value) {
                    if(!value) {
                        this.$font_size.data('range').set(0);
                    } else {
                        this.$font_size.data('range').set(value); 
                    }
                }
            },
            ...
            lineHeight: {
                ...
                set: function(value) {
                    if(!value) {
                        this.$line_height.data('range').set("inherit");
                    } else {
                        this.$line_height.data('range').set(value);
                    }
                }
            },
